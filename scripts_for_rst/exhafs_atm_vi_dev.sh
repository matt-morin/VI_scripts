...
# This script is for testing VI procedure only
# It uses pre-generated FV3 restart files and tc info files
# It only generates a workdir (WORKhafs) and does not create new FV3 restart files under rst_dir

# --- optional settings
export CDATE=2022092000
export STORMID=07L
export deg_box1=10 #30
export deg_box2=24 #45
export res_box1=0.02 
export res_box2=0.2 
export exec=exec_25
export tag=test_25_new 
export vital_dir=/ncrc/home1/Kun.Gao/tshield_vi_driver/tc_vitals/processed_vi1/
export rst_dir=/lustre/f2/dev/Kun.Gao/tshield_vi/${CDATE:0:8}.${CDATE:8:2}Z.C768r10n4_atl_vi_large.nh.32bit.non-mono.0h/rundir/
export WORKhafs=/lustre/f2/scratch/gfdl/Kun.Gao/tshield_vi_work/${CDATE}_box1_${deg_box1}deg_box2_${deg_box2}deg_${tag}/${STORMID}
...
export rst_out_dir=$rst_dir/RESTART_vi/ 
...
if [ $vmax_vit -ge $vi_bogus_vmax_threshold ] && [ ! -s ../anl_pert_guess/storm_pert_new ] ; then
  ...
  ln -sf ../prep_${pert}/vi_inp_${deg_box1}deg${res_box1/\./p}.bin ./fort.36
  ln -sf ../prep_${pert}/vi_inp_${deg_box1}deg${res_box1/\./p}.bin ./fort.46 #roughness
