...
export exec=exec_25_sol1_b
export WORKhafs=/lustre/f2/scratch/gfdl/Kun.Gao/tshield_vi_work_small_sol1_b/${CDATE}/${STORMID}
export rst_out_dir=$rst_dir/RESTART_vi_sol1_b/ 
