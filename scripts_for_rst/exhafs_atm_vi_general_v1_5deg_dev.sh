...
export exec=exec_11
export exp=''
export WORKhafs=/lustre/f2/scratch/gfdl/Kun.Gao/tshield_vi_dev_5deg/${CDATE}${exp}/${STORMID}
...
export deg_box1=${deg_box1:-10} #30
export deg_box2=${deg_box2:-10} #45
