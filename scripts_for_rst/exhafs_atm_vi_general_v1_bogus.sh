...
export WORKhafs=/lustre/f2/scratch/gfdl/Kun.Gao/tshield_vi_work_bogus/${CDATE}/${STORMID}
...
export rst_out_dir=$rst_dir/RESTART_vi_bogus/ 
...
export EXEChafs=${HOMEhafs}/sorc/hafs_tools.fd/exec_ref/
...
export vi_warm_start_vmax_threshold=${vi_warm_start_vmax_threshold:-50} # m/s
...
export deg_box1=${deg_box1:-30} #30
export deg_box2=${deg_box2:-41} #45
...
fi # end if [ $vmax_vit -ge $vi_warm_start_vmax_threshold]
