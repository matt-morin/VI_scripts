...
export exec=exec_25_sol2_e
export WORKhafs=/lustre/f2/scratch/gfdl/Kun.Gao/tshield_vi_work_small_sol2_e/${CDATE}/${STORMID}
export rst_out_dir=$rst_dir/RESTART_vi_sol2_e/ 
