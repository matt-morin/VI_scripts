...
set version = 'v1'
set script = /ncrc/home1/Kun.Gao/vi_driver/scripts_for_ic/exhafs_atm_vi_ic_general_n2.sh
...
while ($x < $end)
  ...
  set ic_dir = /lustre/f2/dev/Kun.Gao/SHiELD_IC_v16/C768r10n2_atl_new/${DATE}.${hh}Z_IC/
