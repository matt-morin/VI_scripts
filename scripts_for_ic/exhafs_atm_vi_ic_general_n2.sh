...
export ic_base_dir=/lustre/f2/dev/gfdl/Kun.Gao/SHiELD_IC_v16/C768r10n2_atl_new/
...
# -- work dir
export work_dir_base=/lustre/f2/scratch/gfdl/Kun.Gao/tshield_vi_work_ic_n2_${version}/
