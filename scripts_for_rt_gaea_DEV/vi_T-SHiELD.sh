#!/bin/bash
#SBATCH --output=/autofs/ncrc-svm1_home2/Matthew.Morin/NGGPS/VI/VI_scripts/scripts_for_rt_gaea_DEV/stdout/%x.out
...
do
  ...
  export vital_base_dir=${HOME}/NGGPS/VI/VI_scripts/scripts_for_rt_gaea_DEV/tc_vitals/processed/
